...
export function TodoFilters({ searchParams }: { searchParams: any }) {
    ...
    return (
        <section className='w-full max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8 mt-8'>
            <Card className='p-6'>
                <CardHeader>
                    <CardTitle className='text-2xl font-bold'>Todos Filter</CardTitle>
                </CardHeader>
                <form>
                    <CardContent className='grid grid-cols-1 gap-6 sm:grid-cols-2'>
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                name='priority'
                            >
                                <SelectTrigger className='p-2 border border-gray-300 rounded-md shadow-sm focus:ring-cyan-500 focus:border-cyan-500'>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                    ...
                    <CardFooter className='flex justify-end mt-6 space-x-4'>
                        ...
                        <Button
                            type='submit'
                            className='bg-cyan-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500'
                        >
                            Apply
                        </Button>
                    </CardFooter>
